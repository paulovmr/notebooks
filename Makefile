...
update-lock-files-minimal:
	...
	cd habana/1.10.0/ubi8-python-3.8 && poetry lock --no-update
	cd habana/1.13.0/ubi8-python-3.8 && poetry lock --no-update
	cd runtimes/minimal/ubi8-python-3.8 && poetry lock --no-update
	cd runtimes/minimal/ubi9-python-3.9 && poetry lock --no-update
